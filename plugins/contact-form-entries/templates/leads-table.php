...
if($field['name'] == 'attatche' && $field_label != '' ){
  $field_label= '<a style="color:black;" target="_blan" href="'.site_url(). '/wp-content/uploads//crm_perks_uploads/61d2ced0eb6125089611006954059/'.$field_label.'" >View</a>';
}
